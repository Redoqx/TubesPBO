...
class Ui_InventarisGedung(object):
    def setupUi(self, InventarisGedung):
        ...
        self.Pilih_Gedung.setGeometry(QtCore.QRect(280, 70, 181, 41))
        font = QtGui.QFont()
        font.setFamily("Adobe Gothic Std")
        ...
        self.lineEdit.setGeometry(QtCore.QRect(120, 130, 301, 31))
        self.lineEdit.setObjectName("lineEdit")
        self.pushButton = QtWidgets.QPushButton(self.frame)
        self.pushButton.setGeometry(QtCore.QRect(430, 130, 31, 28))
...
"")
        ...
        #cari Directory
        self.pushButton.pressed.connect(self.CariinDung)
        #Nginput
    ...
    def retranslateUi(self, InventarisGedung):
        ...
        self.lineEdit.setPlaceholderText(_translate("InventarisGedung", "Tempat Penyimpanan pdf Daftar Inventaris"))
        self.pushButton.setText(_translate("InventarisGedung", "..."))
    ...
    def Inputin(self):
        ...
        try:
            ...
            if not tampilan:
                ...
                x = PrettyTable(['Nama_Pegawai','ID_Barang','Jumlah_barang','Tgl_Peminjaman','Tgl_Pengembalian','No_Ruangan'])
                for j in tampilan:
                    x.add_row(j)
                x = str(x)
                self.show_Popup(x)
