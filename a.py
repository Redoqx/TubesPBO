...
"border-bottom:1px solid;")
        ...
        self.TampilanText = QtWidgets.QLineEdit(self.frame)
        self.TampilanText.setGeometry(QtCore.QRect(10, 50, 1081, 481))
        self.TampilanText.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.TampilanText.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignTop)
        self.TampilanText.setObjectName("TampilanText")
        self.listView = QtWidgets.QListView(self.frame)
        self.listView.setGeometry(QtCore.QRect(60, 100, 256, 192))
        self.listView.setStyleSheet("background-color: rgb(170, 255, 255);")
    ...
    def retranslateUi(self, Tampilan_Text):
        ...
        self.TampilanText.setText(_translate("Tampilan_Text", "Hoy"))
